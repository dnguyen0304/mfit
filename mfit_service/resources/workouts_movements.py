...
class WorkoutsMovements(resources.Base):
    ...
    def get(self, workout_id, movement_id):
        try:
            workout_movement = (
    ...
    def patch(self, workout_id, movement_id):
        workout_movement = (
            self._db_context.query(models.WorkoutsMovements)
                .filter_by(workout_id=workout_id)
                .filter_by(movement_id=movement_id)
    ...
    def delete(self, workout_id, movement_id):
        self._db_context.query(models.WorkoutsMovements) \
                        .filter_by(workout_id=workout_id) \
                        .filter_by(movement_id=movement_id) \
    ...
    def get_self_link(workout_movement):
        self_link = services.api.url_for(
            ...
            movement_id=workout_movement.movement_id,
            _external=True)
        return self_link
